...
*/
@Configuration
public class ProductDetailsBrokerConfig {

    public static final String QUEUE = "product-details-queue";
    public static final String EXCHANGE_NAME = "product-details-exchange";
    public static final String ROUTING_KEY = "product-details-routing";
